...
document.addEventListener('DOMContentLoaded', function() {
    ...
    surveyButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            alert('Thank you for your interest! Survey functionality coming soon.\n\nWe will contact you via email at hello@mutopia.ca');
        });
    });
    ...
    const animateElements = document.querySelectorAll('.testimonial, .hero-text, .challenge-intro');
