            ...
            <div className="flex h-[36px] items-center px-[16px] py-[4px] relative w-full">
              <div className="basis-0 flex grow items-center min-h-px min-w-px relative shrink-0">
                <input
                  ref={ref}
                  {...props}
                  className={`basis-0 font-comfortaa font-normal grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#4a3c2a] text-[12.25px] bg-transparent border-none outline-none placeholder:text-[#717182] w-full ${inputClassName}`}
                />
                {rightElement}
              </div>
            </div>
