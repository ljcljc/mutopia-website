        ...
        <div className="max-w-7xl w-full px-[28px] md:px-[36px] py-[28px]">
          <div className="flex flex-col gap-[24px] items-center w-full">
            ...
            <div className="content-center flex flex-wrap gap-[24px] items-center md:items-start w-full">
              {/* Brand Column */}
              <div className="basis-0 flex flex-col gap-[14px] grow items-start min-w-[272px] w-full md:w-auto">
                {/* Logo and Name */}
                <div className="flex gap-[10.5px] items-center w-full">
                  ...
                  <h3 className="font-comfortaa font-bold leading-[28px] text-white text-[21px]">
                    Mutopia
                  </h3>
                </div>

                {/* Description */}
                <p className="font-comfortaa font-normal leading-[22.75px] text-[14px] text-white w-[224px] whitespace-pre-wrap">
                ...
                <div className="flex gap-[10.5px] items-center w-full">
                  ...
                  <p className="font-comfortaa font-normal leading-[21px] text-[14px] text-white">
                    hello@mutopia.ca
                  </p>
                </div>

                {/* Location */}
                <div className="flex gap-[10.5px] items-center w-full max-w-[273px]">
                  <div className="relative shrink-0 size-[16px]">
                    <Icon
                      name="location"
                      aria-label="Location"
              ...
              <div className="hidden lg:flex basis-0 flex-col gap-[21px] grow items-start min-h-px min-w-px">
                <h4 className="font-comfortaa font-medium leading-[21px] text-[14px] text-white">
                  Quick Links
                </h4>
                <div className="flex flex-col gap-[10.5px] items-start w-full">
                  {quickLinks.map((link, index) => {
                    const linkClassName = "font-comfortaa font-normal leading-[21px] text-[14px] text-white hover:text-[#de6a07] transition-colors duration-200 cursor-pointer";
                ...
                <div className="flex flex-col gap-[10.5px] items-start w-full">
                  {supportLinks.map((link, index) => (
                    <a
                      key={index}
                      href={link.href}
                      className="font-comfortaa font-normal leading-[21px] text-[14px] text-white hover:text-[#de6a07] transition-colors duration-200 cursor-pointer"
                    >
                      {link.label}
                    </a>
                  ))}
              ...
              {/* Follow Us Column */}
              <div className="flex flex-col gap-[21px] items-start shrink-0 w-full md:w-auto">
                <div className="flex flex-col gap-[14px] items-start w-[133px]">
                  <h4 className="font-comfortaa font-medium leading-[21px] text-[14px] text-white">
                    Follow Us
                  </h4>
            ...
            <div className="content-center flex flex-col md:flex-row flex-wrap gap-[24px] items-center md:items-start justify-center md:justify-between w-full">
              <p className="flex-[1_0_0] font-comfortaa font-normal min-h-px min-w-px leading-[17.5px] text-[12.25px] text-center md:text-left text-white whitespace-pre-wrap order-1 md:order-1">
                © 2026 Mutopia. All rights reserved.
              </p>
              <div className="h-[17.5px] relative shrink-0 order-2 md:order-2">
                <div className="flex font-comfortaa font-normal gap-[24px] h-[17.5px] items-start leading-[17.5px] text-[12.25px] text-white">
                  <a
                    href="#"
