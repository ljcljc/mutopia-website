    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-8 md:px-12 lg:px-[57.5px]">
        ...
        <div>
          ...
          <p className="font-comfortaa text-[18px] text-[#4a3c2a] mb-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
          ...
          <p className="font-comfortaa text-[14px] text-[rgba(74,60,42,0.7)] mt-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="font-comfortaa text-[14px] text-[#de6a07] underline hover:text-[#c25a06] transition-colors"
              >
                Toggle manually
              </button>
            </div>
        ...
        <div className="bg-blue-50 p-8 rounded-lg">
          <h2 className="font-comfortaa text-[28px] leading-[36px] text-[#633479] mb-4">
            Technical Implementation
          </h2>
          <div className="space-y-3 font-comfortaa text-[14px] text-[#4a3c2a]">
            <p>
