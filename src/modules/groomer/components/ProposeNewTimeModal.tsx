      ...
      <DialogContent
        ...
        className={cn(
          ...
          isMobile
            ...
            : "left-1/2! top-1/2! z-[75]! flex! max-h-[80vh]! w-[min(560px,calc(100vw-48px))]! max-w-[560px]! -translate-x-1/2! -translate-y-1/2! gap-0! rounded-[24px] shadow-[0px_24px_60px_rgba(74,44,85,0.16)]",
        )}
      >
