    ...
    <>
      ...
      <section className="mt-5 rounded-2xl bg-[#FFF9ED] p-6 shadow-lg">
        <div className="flex items-center justify-between gap-4">
          <h2 className="font-comfortaa text-xl text-[#7B4A20]">
            ✣ Groomer &amp; AI Insights
          </h2>
        ...
        {editing ? (
          <div className="mt-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="rounded-full border border-[#633479] px-4 py-3 text-[#633479]"
              >
                Cancel
              </button>
              <OrangeButton
          ...
          <p className="mt-4 leading-7 text-[#6C4D32]">
      ...
      <h2 className="mt-8 font-comfortaa text-2xl text-white">
        Wellness Summary
      </h2>
