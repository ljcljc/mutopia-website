...
function Mutopia() {
  return (
    <div className="basis-0 grow h-[28px] min-h-px min-w-px relative shrink-0" data-name="Mutopia">
...
function Logo() {
  return (
    <div className="h-[35px] relative shrink-0 w-[138.32px]" data-name="Logo">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[10.5px] h-[35px] items-center relative w-[138.32px]">
        <Icon />
        <Mutopia />
      </div>
    </div>
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[10px] items-center justify-center relative w-full">
        <p className="font-['Comfortaa:Regular',_sans-serif] font-normal leading-[21px] relative shrink-0 text-[#4a3c2a] text-[14px] text-nowrap whitespace-pre">Membership</p>
      </div>
    </div>
  );
}
...
function Navigation() {
  return (
    <div className="h-[21px] relative shrink-0 w-[382.195px]" data-name="Navigation">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[28px] h-[21px] items-center relative w-[382.195px]">
        <Link />
        <Link1 />
        <Link2 />
        <Link3 />
...
function GenericAvatar() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Generic avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Generic avatar">
          <rect fill="var(--fill-0, #8B6357)" height="20" rx="10" width="20" />
          <g id="Avatar Placeholder">
            <path clipRule="evenodd" d={svgPaths.p259efe00} fill="var(--fill-0, white)" fillRule="evenodd" />
            <path d={svgPaths.p18131300} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
...
function ButtonTertiary() {
  return (
    <div className="relative shrink-0 w-[134px]" data-name="Button tertiary">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] items-center px-[12px] py-[4px] relative w-[134px]">
        <GenericAvatar />
        <p className="font-['Comfortaa:Medium',_sans-serif] font-medium leading-[17.5px] relative shrink-0 text-[#8b6357] text-[12px] text-nowrap whitespace-pre">Christophe</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="notifications">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="notifications">
          <path d={svgPaths.p23185c80} fill="var(--fill-0, #8B6357)" id="icon" />
        </g>
      </svg>
    </div>
  );
...
function Buttons() {
  return (
    <div className="h-[28px] relative shrink-0 w-[281.008px]" data-name="Buttons">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[10.5px] h-[28px] items-center relative w-[281.008px]">
