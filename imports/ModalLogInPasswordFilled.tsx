import svgPaths from "./svg-owrf0j59y7";
...
function Frame5() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Comfortaa:Regular',_sans-serif] font-normal grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#717182] text-[12.25px]">∙∙∙∙∙∙∙∙</p>
      <Visible />
    </div>
  );
}
...
function Spiner() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Spiner">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Spiner">
          <path d={svgPaths.p248f200} fill="var(--fill-0, white)" id="Ellipse 1" />
        </g>
      </svg>
    </div>
  );
...
export default function ModalLogInPasswordFilled() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[16px] items-start pb-[32px] pt-[12px] px-0 relative rounded-[20px] size-full" data-name="Modal_log in_password filled">
