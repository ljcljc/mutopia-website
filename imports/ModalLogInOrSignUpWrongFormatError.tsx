import svgPaths from "./svg-naric81pth";
...
function Frame5() {
  return (
    <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px relative shrink-0">
      <p className="basis-0 font-['Comfortaa:Regular',_sans-serif] font-normal grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#717182] text-[12.25px]">sjdnjn</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <Alert />
      <p className="font-['Comfortaa:Medium',_sans-serif] font-medium leading-[17.5px] relative shrink-0 text-[#de1507] text-[12px] text-nowrap whitespace-pre">Enter a valid email.</p>
    </div>
  );
}
...
function AuthDialog1() {
  return (
    <div className="h-px relative shrink-0 w-[371px]" data-name="AuthDialog">
      <PrimitiveDiv1 />
      <Text />
    </div>
  );
...
export default function ModalLogInOrSignUpWrongFormatError() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[16px] items-start pb-[32px] pt-[12px] px-0 relative rounded-[20px] size-full" data-name="Modal_Log in or sign up_wrong format error">
